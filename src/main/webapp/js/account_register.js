...
(function() {
  ...
  Account.addUpd_account = function (partiallySecure) {
    var e;
    if (!callApiLock) {
      callApiLock = true;
      try {
        if (Account.actualId) {
          ...
          var url = "";
          if (partiallySecure) {
            url = "/accountpayable/edit/" + Account.actualId + "/true";
          } else {
            url = "/accountpayable/edit/" + Account.actualId + "/false";
          }
          return $.post(url, new Account(), function(t) {
            if (t == 'true') {
